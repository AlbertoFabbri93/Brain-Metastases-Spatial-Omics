...
patient_1_IST_de_genes <- find_most_significant_markers(patient_1_data, "InSituType_semisup_clusters", "Nanostring")
...
write.csv(patient_1_IST_de_genes, paste0(get_patient_dir_img("1"), "Patient_1_IST_de_genes.csv"), row.names = TRUE)
```
...
patient_2_IST_de_genes <- find_most_significant_markers(patient_2_data, "InSituType_semisup_clusters", "Nanostring")
...
write.csv(patient_2_IST_de_genes, paste0(get_patient_dir_img("2"), "Patient_2_IST_de_genes.csv"), row.names = TRUE)
```
...
patient_3_IST_de_genes <- find_most_significant_markers(patient_3_data, "InSituType_semisup_clusters", "Nanostring")
...
write.csv(patient_3_IST_de_genes, paste0(get_patient_dir_img("3"), "Patient_3_IST_de_genes.csv"), row.names = TRUE)
```
...
patient_4_IST_de_genes <- find_most_significant_markers(patient_4_data, "InSituType_semisup_clusters", "Nanostring")
...
write.csv(patient_4_IST_de_genes, paste0(get_patient_dir_img("4"), "Patient_4_IST_de_genes.csv"), row.names = TRUE)
```
...
patient_5_IST_de_genes <- find_most_significant_markers(patient_5_data, "InSituType_semisup_clusters", "Nanostring")
...
write.csv(patient_5_IST_de_genes, paste0(get_patient_dir_img("5"), "Patient_5_IST_de_genes.csv"), row.names = TRUE)
```
...
patient_6_IST_de_genes <- find_most_significant_markers(patient_6_data, "InSituType_semisup_clusters", "Nanostring")
...
write.csv(patient_6_IST_de_genes, paste0(get_patient_dir_img("6"), "Patient_6_IST_de_genes.csv"), row.names = TRUE)
```
...
patient_7_IST_de_genes <- find_most_significant_markers(patient_7_data, "InSituType_semisup_clusters", "Nanostring")
...
write.csv(patient_7_IST_de_genes, paste0(get_patient_dir_img("7"), "Patient_7_IST_de_genes.csv"), row.names = TRUE)
```
