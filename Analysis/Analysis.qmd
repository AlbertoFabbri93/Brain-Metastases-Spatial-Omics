...
tidy_seurat_object_assay <- function(seurat_object_mixed_features, assay_name) {
  ...
  system_control_assay <- CreateAssayObject(counts = system_control_counts)
  negative_probes_assay <- CreateAssayObject(counts = negative_probes_counts)
  gene_assay <- CreateAssayObject(counts = gene_counts)
