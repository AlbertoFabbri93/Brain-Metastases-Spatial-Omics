...
patient_5_data$RNA_clusters_annotated <- case_match(
  ...
  c("0", "1") ~ "Tumor",
  c("2", "4", "5") ~ "Dendritic cells",
  "3" ~ "Fibroblasts",
  "5" ~ "Macrophage",
  "6" ~ "Endothelial cells/Fibroblasts",
  "7" ~ "T-cells/Dendritic cells",
  "8" ~ "T-cells",
)
...
patient_6_data$RNA_clusters_annotated <- case_match(
  ...
  c("0", "1", "2", "4") ~ "Tumor",
  "3" ~ "Fibroblasts/Endothelial cells",
  "5" ~ "Macrophage",
)
...
patient_7_data$RNA_clusters_annotated <- case_match(
  ...
  c("0", "1", "2", "3") ~ "Tumor",
  "4" ~ "T-cells/Dendritic cells",
  "5" ~ "Dendritic cells",
  "6" ~ "Dendritic cells",
  "7" ~ "Fibroblasts/Endothelial cells",
  "8" ~ "Fibroblasts"
)
