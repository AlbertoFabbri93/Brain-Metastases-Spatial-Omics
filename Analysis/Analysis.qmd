...
patient_1_plots <- c(patient_1_plots, generate_rna_plots(patient_1_data, "RNA"))
...
patient_1_plots$patient_1_RNA_de_genes <- find_most_significant_markers(patient_1_data, "RNA_clusters", "RNA")
patient_1_plots$patient_1_IST_de_genes <- find_most_significant_markers(patient_1_data, "InSituType_semisup_clusters", "RNA")
...
patient_2_plots <- c(patient_2_plots, generate_rna_plots(patient_2_data, "RNA"))
...
patient_2_plots$patient_2_RNA_de_genes <- find_most_significant_markers(patient_2_data, "RNA_clusters", "RNA")
patient_2_plots$patient_2_IST_de_genes <- find_most_significant_markers(patient_2_data, "InSituType_semisup_clusters", "RNA")
...
patient_3_plots <- c(patient_3_plots, generate_rna_plots(patient_3_data, "RNA"))
...
patient_3_plots$patient_3_RNA_de_genes <- find_most_significant_markers(patient_3_data, "RNA_clusters", "RNA")
patient_3_plots$patient_3_IST_de_genes <- find_most_significant_markers(patient_3_data, "InSituType_semisup_clusters", "RNA")
...
patient_4_plots <- c(patient_4_plots, generate_rna_plots(patient_4_data, "RNA"))
...
patient_4_plots$patient_4_RNA_de_genes <- find_most_significant_markers(patient_4_data, "RNA_clusters", "RNA")
patient_4_plots$patient_4_IST_de_genes <- find_most_significant_markers(patient_4_data, "InSituType_semisup_clusters", "RNA")
...
patient_5_plots <- c(patient_5_plots, generate_rna_plots(patient_5_data, "RNA"))
...
patient_5_plots$patient_5_RNA_de_genes <- find_most_significant_markers(patient_5_data, "RNA_clusters", "RNA")
patient_5_plots$patient_5_IST_de_genes <- find_most_significant_markers(patient_5_data, "InSituType_semisup_clusters", "RNA")
...
patient_6_plots <- c(patient_6_plots, generate_rna_plots(patient_6_data, "RNA"))
...
patient_6_plots$patient_6_RNA_de_genes <- find_most_significant_markers(patient_6_data, "RNA_clusters", "RNA")
patient_6_plots$patient_6_IST_de_genes <- find_most_significant_markers(patient_6_data, "InSituType_semisup_clusters", "RNA")
...
patient_7_plots <- c(patient_7_plots, generate_rna_plots(patient_7_data, "RNA"))
...
patient_7_plots$patient_7_RNA_de_genes <- find_most_significant_markers(patient_7_data, "RNA_clusters", "RNA")
patient_7_plots$patient_7_IST_de_genes <- find_most_significant_markers(patient_7_data, "InSituType_semisup_clusters", "RNA")
