...
breast_cancer_patients <- readRDS("./Seurat_objects/breast_cancer_patients.rds")
...
patient_1_rna_data <- analyze_patient(breast_cancer_patients, "1")
...
patient_2_rna_data <- analyze_patient(breast_cancer_patients, "2")
...
patient_3_rna_data <- analyze_patient(breast_cancer_patients, "3")
...
patient_4_rna_data <- analyze_patient(breast_cancer_patients, "4")
...
patient_5_rna_data <- analyze_patient(breast_cancer_patients, "5")
...
patient_6_rna_data <- analyze_patient(breast_cancer_patients, "6")
...
patient_7_rna_data <- analyze_patient(breast_cancer_patients, "7")
