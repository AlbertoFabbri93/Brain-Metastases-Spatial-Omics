...
ggsave(paste(patient_subfolder, "Patient_",  patient_num, "_krt17.png", sep = ""))
  ...
  diff_expr_genes_heatmap <- DoHeatmap(patient_rna_only, features = most_significant_markers$gene, assay = "Nanostring") + ggtitle(paste("Patient", patient_num), subtitle = "Top 10 Differentially Expressed Genes")
  ggsave(filename = paste(patient_subfolder, "Patient_",  patient_num, "_diff_expr_genes_heatmap.png", sep = ""), plot = diff_expr_genes_heatmap)
